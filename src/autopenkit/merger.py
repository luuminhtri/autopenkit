        ...
        final_findings.append(
            FinalFinding(
                **finding.model_dump(mode="json"),
                ...
                ai_validation_status=analysis.ai_validation_status,
                ai_evidence_quality=analysis.ai_evidence_quality,
                ...
                ai_priority_rationale=analysis.ai_priority_rationale,
                ai_remediation_owner=analysis.ai_remediation_owner,
                ai_technology_context=analysis.ai_technology_context,
                ...
                ai_config_examples=analysis.ai_config_examples,
                ai_follow_up_scan_recommendations=(
                    analysis.ai_follow_up_scan_recommendations
                ),
